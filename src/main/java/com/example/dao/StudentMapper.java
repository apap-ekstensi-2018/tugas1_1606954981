...
public interface StudentMapper
{
    ...
    /*@Update("UPDATE mahasiswa SET nama = #{nama}, tempat_lahir = #{tempat_lahir}, tanggal_lahir = #{tanggal_lahir}, jenis_kelamin = #{jenis_kelamin}, agama = #{agama}"
 		   + "golongan_darah = #{golongan_darah}, tahun_masuk = #{tahun_masuk}, jalur_masuk = #{jalur_masuk}, status = #{status}, id_prodi = #{id_prodi}")
